...
package org.esa.beam.akh.adam.auxdata;
...
public class Luts {
    ...
    private static final String nskyLutDwPattern = "%INSTRUMENT%/%INSTRUMENT%_ContinentalI_80_Nsky_dw_modis.bin";
    private static final String nskyLutDUpPattern = "%INSTRUMENT%/%INSTRUMENT%_ContinentalI_80_Nsky_up_modis.bin";
    private static final String coeffPattern = "%INSTRUMENT%/%INSTRUMENT%2modis_coefs_rmse.txt";
    private static final String coeffDPattern = "%INSTRUMENT%/N2MODIS_coefs_%INSTRUMENT%_Ddw_Dup.txt";
