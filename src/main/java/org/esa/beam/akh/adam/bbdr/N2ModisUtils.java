...
public class N2ModisUtils {
    ...
    /**
     * reads a NSky DW LUT (BBDR breadboard procedure GA_read_LUT_Nsky, first
     * LUT) * This LUT is equivalent to the original IDL LUT. * A LUT value can
     * be accessed with lut.getValue(new double[]{wvlValue, ozoValue, cwvValue,
     * angValue, kxValue, kxcaseValue});
     *
     * @param sensor The sensor
     * @return LookupTable
     * @throws java.io.IOException when failing to real LUT data
